define("super/kmeans/0.5.1/kmeans-debug", [ "./distance-debug" ], function() {
    var distances = require("./distance-debug");
    ...
    return function(points, k, distance, snapshotPeriod, snapshotCb) {
...
define("super/kmeans/0.5.1/distance-debug", [], {
